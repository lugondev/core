...
alias ark="$HOME/qlug-core/packages/core/bin/run"
echo 'alias qlug="$HOME/qlug-core/packages/core/bin/run"' >> ~/.bashrc
...
rm -rf "$HOME/.config/@qlug"
rm -rf "$HOME/.config/@qlug"
rm -rf "$HOME/.config/qlug-core"
